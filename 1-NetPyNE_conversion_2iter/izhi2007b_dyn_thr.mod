...
NEURON {
  ...
  RANGE C, k, vr, vt, vt0, u0, vpeak, u, a, b, c, d, alpha, Vi, Vmin, Ka, Ki, tau, Iin, celltype, alive, cellid, verbose, derivtype, delta, t0
