...
% to be implemented:
includemodulationyn = 0;                                    % direct whisker modulation of L23 neurons (0 = no, 1=yes)

% How to save everything
savename = ['Test_sim_Svoboda'];

run_sim(make_new_thalamic_input,make_new_thalamic_kernels,make_new_connectivity,includemodulationyn,savename)